        ...
        <div class="card-body">
            ...
            >
                ...
                <el-row :gutter="20" class="mt-2">
                    ...
                    <el-col :xs="25" :sm="6" :md="8" :lg="20" :xl="2">
                        <el-upload
                            ...
                            accept=".docx,.doc"
                        >
                            <el-button size="medium" type="primary"><i class="fas fa-file-word"></i></el-button>
                        </el-upload>
                    </el-col>
                ...
                <el-row :gutter="20" class="mt-2">
                    <el-col :xs="25" :sm="6" :md="8" :lg="20" :xl="24">
                        <div>
                            Solo archivos PDF y WORD con un tamaño menor de 500kb
                        </div>
                    </el-col>
                </el-row>
            </el-dialog>
