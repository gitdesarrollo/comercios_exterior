<template>
  <div class="card">
    ...
    <div class="card-body">
          ...
          <template slot-scope="scope" class="pl-3">
            ...
            <div v-else>
              ...
              <el-popover
                ...
                width="250"
                trigger="hover"
                content="Asignación a agrupador"
              >
                <el-button
                  slot="reference"
                  v-if="scope.row.agrupado === 0 && scope.row.rol === 7"
                  size="mini"
                  type="primary"
                  icon="el-icon-document-copy"
                  plain
                  @click="getPadreAgrupador(scope.row.code)"
                ></el-button>
              </el-popover>
      ...
      >
          ...
          <table>
            <tbody>
              <tr>
                <td>
                  <img
                    :src="handlerDialog.boleta.img"
                    class="constancia-img"
                    height="120px"
                    width="5%"
                  />
                </td>
        ...
        <el-row :gutter="20" class="mt-5">
          <el-col :span="12" :offset="0">
            <el-button type="warning" size="default" @click="imprimir"
              >Imprimir</el-button
            >
          </el-col>
        </el-row>
      ...
      <el-dialog
        title="Asignación de Agrupador"
        :visible.sync="agrupador"
        width="35%"
        top="3vh"
        center
        :close-on-click-modal="false"
      ...
      >
        ...
        >
          <el-form-item label="Agrupador:" prop="agrupador">
            <el-select
              v-model="formPadre.id"
              class="select_width"
              clearable
              filterable
              placeholder="Seleccione Agrupador"
            >
              <el-option
                v-for="items in list_response.list_padres"
                :key="items.id"
      ...
      >
        <el-row :gutter="10">
          ...
          <el-col :xs="24" :sm="24" :md="12" :lg="12" :xl="12">
            ...
            <b-alert v-show="handlerFile.showError" show variant="danger"
              >Sin documento Adjunto</b-alert
            >
      ...
      <div class="block">
        ...
        >
          ...
          <el-form-item label="Viceministerio:">
            <el-select
              v-model="formInstrucciones.viceministerio"
            ...
            >
              <el-option
                v-for="item in list_response.listaVice"
                :key="item.id"
                :label="item.descripcion"
                :value="item.id"
              >
