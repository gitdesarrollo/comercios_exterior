    ...
    <el-row :gutter="10" class="mt-2">
      ...
      <div class="block mt-5 ">
        <!-- <el-timeline class="overflow-auto">
          <el-timeline-item v-for="item in list_response.listado_bitacora" :key="item.id" :timestamp="item.fecha" placement="top">
            <el-card>
              <h4>{{ item.usuario + "  -  "+item.dependencia + "  " + item.fecha }}</h4>
