<template>
  <div>
    <div class="card">
      <div class="card-header text-white bg-primary">Catálogo de Entidades</div>
      <div class="card-body">
        <el-form ref="form" :model="form" :rules="rules" label-width="150px">
          <el-form-item label="Nombre de Entidad" prop="name">
        ...
        >
          ...
          <el-table-column label="Entidad" prop="name"></el-table-column>
